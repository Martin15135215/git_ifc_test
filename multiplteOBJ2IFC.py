...
class Obj2Ifc:
    ...
    def create_ifc_file(self, version="IFC4"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("dir", type=str, help="The directory where the obj file are")
    args = parser.parse_args()

    obj2ifc = Obj2Ifc()
    obj2ifc.create_ifc_file()
    obj2ifc.format = "obj"
    for path in Path(args.dir).glob("*.obj"):
        obj2ifc.execute(path)
    obj2ifc.write(str(Path(args.dir) / "Final.ifc"))
